 ...
 * @author Milagritos
 */
public class CatalogoEdit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Gestor Catálogo / Editar Libro");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CatalogoEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CatalogoEdit().setVisible(true);
            }
        });
    }
